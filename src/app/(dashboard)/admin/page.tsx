      ...
      <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-800/60 pb-5">
        <div>
          <h1 className="text-2xl font-black text-slate-100 flex items-center gap-2.5">
            <ShieldCheck className="w-7 h-7 text-rose-450" />
            لوحة السوبر أدمن (سند كار)
          </h1>
          <p className="text-xs text-slate-400 mt-1">
            إدارة المكاتب، وتعيين الصلاحيات، ومتابعة نشاط أسطول السيارات الفعلي بالكامل
          </p>
        </div>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="bg-slate-900/60 border-slate-800 backdrop-blur-lg">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            ...
            <div className="p-2 rounded-lg border border-rose-500/20 bg-rose-500/10 text-rose-450">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl relative">
            <div className="p-6 border-b border-slate-800 flex justify-between items-center">
              <h3 className="text-lg font-black text-slate-100 flex items-center gap-2">
                <Building className="w-5 h-5 text-rose-450" />
                إضافة مكتب تأجير سيارات جديد
              </h3>
              <button onClick={() => setShowAddTenantModal(false)} className="text-slate-450 hover:text-slate-200">
                <X className="w-5 h-5" />
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl relative">
            <div className="p-6 border-b border-slate-800 flex justify-between items-center">
              ...
              <button onClick={() => setShowAddMemberModal(false)} className="text-slate-450 hover:text-slate-200">
                <X className="w-5 h-5" />
              </button>
            </div>
